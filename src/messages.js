...
exports.needsInfo = (username: string) => stripIndent`
    ...
    of volunteers that help maintain this project. The easier it is for us to decipher an issue with the info
    provided, the more likely it is that we'll be able to help.
    ...
    Please provide either a link to the problem via the [\`repl\`](https://babeljs.io/repl/), or if the
    \`repl\` is insufficient, a new and minimal repository with instructions on how to build/replicate the
    issue.
`;
